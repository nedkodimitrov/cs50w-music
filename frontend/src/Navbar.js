...
export default function Navbar({ isAuth, setIsAuth }) {
  ...
  const mainMenuId = 'primary-search-main-menu';
  const renderMainMenu = (
    ...
    >
      <MenuItem onClick={handleMainMenuClose}>New Song</MenuItem>
      <MenuItem onClick={handleMainMenuClose}>New Album</MenuItem>
    </Menu>
  );
