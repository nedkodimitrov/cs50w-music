...
class Album(models.Model):
    ...
    image_album_cover = models.ImageField(upload_to='albums/images', blank=True, null=True)
...
class Song(models.Model):
    ...
    image_song_cover = models.ImageField(upload_to='songs/images', blank=True, null=True)
